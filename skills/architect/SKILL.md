...
- **Offer options with a suggested pick.** Present 2 to 4 current, real options, mark the one you would suggest with a short why, and always include a free-text **"Other"**. The suggestion helps the engineer decide fast, but **they choose** — you are walking them through the decision, not making it for them.
- **Confirm panels at the end of a stage** (the assembled data model, accept the ADR, References consent, an overlapping ADR) also carry one suggested option plus **"Other"**.
